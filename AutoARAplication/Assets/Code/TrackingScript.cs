...
// /// </summary>
// public class TrackingScript : MonoBehaviour, IPointerClickHandler
// {
//     // downscaling const
...
//     {
//         var ri = rawImage.rectTransform;

//         Vector2 output = new Vector2();
//         RectTransformUtility.ScreenPointToLocalPointInRectangle(ri, coord, null, out output);
...
//         {
//             Mat image = Unity.TextureToMat(webCamTexture, TextureParameters);
...
//             rawImage.texture = Unity.MatToTexture(image, rawImage.texture as Texture2D);
//         }
//     }
...
//             trackedObjectInstance = Instantiate(objectToTrack, worldPosition, Quaternion.identity);
//         }
//     }
// }